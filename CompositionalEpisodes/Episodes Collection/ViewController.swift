...
class ViewController: UIViewController {
    ...
    private func configureCollectionView() {
        ...
        let unreadIndicatorRegistration = UICollectionView.SupplementaryRegistration<UnreadIndicator>(elementKind: SupplementaryElementKind.unreadIndicator) { indicator, kind, indexPath in
        ...
        datasource.supplementaryViewProvider = { collectionView, kind, indexPath in
            ...
            case SupplementaryElementKind.unreadIndicator:
                return collectionView.dequeueConfiguredReusableSupplementary(using: unreadIndicatorRegistration, for: indexPath)
